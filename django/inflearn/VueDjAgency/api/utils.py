def obj_to_post(obj, flag=True):
    """
    obj의 각 속성을 serialize 해서, dict로 변환
    serialize: python object --> (기본 타입) int, float, str 형변환
    :param obj:
